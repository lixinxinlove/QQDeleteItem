package com.lixinxin.deleteitem.widgit;
...
/**
 * 作者:李鑫鑫 邮件:lixinxinlove0105@gmail.com
 * 创建时间:15/5/26 上午2:07
 * 描述:适用于AbsListView和RecyclerView的水平方向滑动item。【作为AbsListView的item单击和长按参考代码家的https://github.com/daimajia/AndroidSwipeLayout】
 */
public class LXXSwipeItemLayout extends FrameLayout {
    private static final String TAG = LXXSwipeItemLayout.class.getSimpleName();
    ...
    public LXXSwipeItemLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LXXSwipeItemLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LXXSwipeItemLayout);
    ...
    private void initAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.LXXSwipeItemLayout_bga_sil_swipeDirection) {
            // 默认向左滑动
        ...
        } else if (attr == R.styleable.LXXSwipeItemLayout_bga_sil_bottomMode) {
            // 默认是拉出
        ...
        } else if (attr == R.styleable.LXXSwipeItemLayout_bga_sil_springDistance) {
            // 弹簧距离，不能小于0，默认值为0
        ...
        } else if (attr == R.styleable.LXXSwipeItemLayout_bga_sil_swipeAble) {
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() != 2) {
            throw new IllegalStateException(LXXSwipeItemLayout.class.getSimpleName() + "必须有且只有两个子控件");
        }
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(LXXSwipeItemLayout.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, LXXSwipeItemLayout.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, LXXSwipeItemLayout.this, p, vId);
                }
                if (handled) {
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            ViewCompat.postInvalidateOnAnimation(LXXSwipeItemLayout.this);
        }
    ...
    public interface BGASwipeItemLayoutDelegate {
         ...
         */
        void onBGASwipeItemLayoutOpened(LXXSwipeItemLayout swipeItemLayout);
         ...
         * @param swipeItemLayout
         */
        void onBGASwipeItemLayoutClosed(LXXSwipeItemLayout swipeItemLayout);
         ...
         * @param swipeItemLayout
         */
        void onBGASwipeItemLayoutStartOpen(LXXSwipeItemLayout swipeItemLayout);
    }
